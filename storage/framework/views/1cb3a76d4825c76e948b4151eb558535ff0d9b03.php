...
?>
 ...
 <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
   ...
   <div class="row">
		...
		<div class="col-sm-8">
		<h6><?php echo e($tourist_arrivls); ?></h6>
		</div>
		<div class="col-sm-4">
   ...
   <div class="row">
		...
		<div class="col-sm-8">
		<h6><?php echo e($tourist_departures); ?></h6>
		</div>
		<div class="col-sm-4">
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Reports/overview.blade.php ENDPATH**/ ?>