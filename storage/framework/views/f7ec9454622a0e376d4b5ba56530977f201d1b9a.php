...
?>
   ...
   <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="mr-2">
            <p><small>
			Total Arrivals <span data-feather="users"></span>: <?php echo e($tourist_arrivls); ?><br>
            Total Departures <span data-feather="users"></span>: <?php echo e($tourist_departures); ?><br>
            Most used entry point <span data-feather="chevrons-left"></span>: <?php echo e($a); ?><br>
            Most used entry point type <span data-feather="list"></span>: <?php echo e($ta); ?><br>
            Most active entry month <span data-feather="calender"></span>: <?php echo e($am); ?><br>
            Most used exit point <span data-feather="chevrons-left"></span>: <?php echo e($d); ?><br>
            Most used exit point type <span data-feather="list"></span>: <?php echo e($td); ?><br>
			Most active exit month <span data-feather="calender"></span>: <?php echo e($dm); ?>
		  ...
		  <form class="needs-validation" novalidate  method="POST" action="generate">
            ...
            <select class="form-control" id="contintent"  name="filter"  value="" required>
					<option>Choose Region/Continent</option>	
					  <?php echo $__env->make('Lists.continents', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
					</select>					 
            <div class="invalid-feedback">
              Valid first name is required.
            </div>
		  ...
		  <form class="needs-validation" novalidate  method="POST" action="generate">
           ...
           <select class="form-control" id="contintent"  name="filter"  value="" required>
					<option>Choose Point</option>
					 ...
					 <option value="<?php echo e($po->name); ?>"><?php echo e($po->name); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>	
					</select>
            <div class="invalid-feedback">
              Valid first name is required.
	...
	<!-- Begin Form -->
		  <form class="needs-validation" novalidate  method="POST" action="generate">
            ...
            <input type="text" class="form-control" list="year" id="years" name="filter" placeholder="Year" value="" required>
					...
					<?php $__currentLoopData = $arrival; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					 <option value="<?php echo e($ay->year); ?>"><?php echo e($ay->year); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					<?php $__currentLoopData = $departure; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						<option value="<?php echo e($d->year); ?>"><?php echo e($d->year); ?></option>
					<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Reports/by_arrivals.blade.php ENDPATH**/ ?>