...
<?php $__env->startSection('content'); ?>
  ...
  <div class="row">
    ...
    <div class="col-md-10 order-md-1">
      ...
      <form class="needs-validation" novalidate  method="POST" action="create_museum">
        <?php echo csrf_field(); ?>
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="name" name="name" placeholder="Museum Name" value="" required>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Museums/museums.blade.php ENDPATH**/ ?>