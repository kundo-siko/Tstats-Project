  ...
  <div class="row">
    ...
    <div class="col-md-6 order-md-2">
		...
		<input type="text" class="form-control" id="self_drivers" name="self_drivers" value="Not Applicable" hidden>
			<div id="txtHint">Select a National Park</div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Parks/add_park_visit.blade.php ENDPATH**/ ?>