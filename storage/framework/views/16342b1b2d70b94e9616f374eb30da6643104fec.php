      ...
      <form class="needs-validation" novalidate  method="POST" action="create_point">
		...
		<div class="mb-3">
            ...
            <select class="form-control" id="region" name="region">
			  ...
			  <?php echo $__env->make('Lists.region', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
			</select>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Points_of_entry/add_point.blade.php ENDPATH**/ ?>