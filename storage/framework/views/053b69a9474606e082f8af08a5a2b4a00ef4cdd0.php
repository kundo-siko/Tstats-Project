  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a href="<?php echo e(url('heritage')); ?>" class="btn btn-sm btn-outline-secondary">Add New Site <span data-feather="plus"></span></a>
			<?php if(url()->current()!='http://127.0.0.1:8000/view_my_heritage'): ?>
            <a href="<?php echo e(url('view_my_heritage')); ?>" class="btn btn-sm btn-outline-secondary">By Me <span data-feather="user"></span></a>
				<?php else: ?>
			<a href="<?php echo e(url('view_heritage')); ?>" class="btn btn-sm btn-outline-secondary">By All <span data-feather="users"></span></a>
				<?php endif; ?>
            <a  href="<?php echo e(url('heritage_excel')); ?>" class="btn btn-sm btn-outline-secondary">Export <span data-feather="share"></span></a>
          </div>
        ...
        <table class="table table-striped table-sm">
          ...
          <tbody>
			<?php 
				$sn = '1';
			?>
			 <?php $__currentLoopData = $sites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $a): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <tr>
              <td><?php echo e($sn++); ?></td>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Heritage/view_heritage_sites.blade.php ENDPATH**/ ?>