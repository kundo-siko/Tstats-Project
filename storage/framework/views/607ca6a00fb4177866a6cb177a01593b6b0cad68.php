...
<?php $__env->startSection('content'); ?>
  ...
  <div class="py-5 text-center">
    ...
    <p class="lead">Below fields you can use to add a Special Tourist. Please fil in each field correctly.</p>
  </div>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Arrivals/add_special.blade.php ENDPATH**/ ?>