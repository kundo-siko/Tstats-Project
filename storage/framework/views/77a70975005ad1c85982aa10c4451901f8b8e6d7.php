...
var foreign = ["Foreign/Unspecified"];
...
var fe = "Foreign/Unspecified"; //For unspecified international visitors
...
if(n){
	...
	//document.getElementById("demoo").innerHTML = at;
	document.getElementById('memo').value = fe;
}
...
function showCustomer(str) {
  ...
  xhttp.open("GET", "museum_fee?q="+str, true);
  xhttp.send();
}
</script>
...
<?php /**PATH C:\wamp64\www\Tstats\resources\views/Museums/pick.blade.php ENDPATH**/ ?>