...
?>
   ...
   <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="mr-2">
            <p><small>
			Total Number of Museums <span data-feather="users"></span>: <?php echo e($park_n); ?><br>
            Total Number of Museum Visits <span data-feather="users"></span>: <?php echo e($visits_n); ?><br>
		...
		<!-- Begin Form -->
		  <form class="needs-validation" novalidate  method="POST" action="generate">
            ...
            <select class="form-control" id="contintent"  name="filter"  value="" required>
					...
					<?php $__currentLoopData = $museums; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
	...
	<!-- Begin Form -->
		  <form class="needs-validation" novalidate  method="POST" action="generate">
            ...
            <input type="text" class="form-control" list="year" id="years" name="filter" placeholder="Year" value="" required>
					...
					<?php $__currentLoopData = $museum_visits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\Tstats\resources\views/Reports/by_museums.blade.php ENDPATH**/ ?>