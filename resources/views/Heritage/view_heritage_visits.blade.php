  ...
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
        ...
        <div class="btn-toolbar mb-2 mb-md-0">
          <div class="btn-group mr-2">
            <a href="{{ url('heritage_visit') }}" class="btn btn-sm btn-outline-secondary">Add Site Visit <span data-feather="plus"></span></a>
			@if(url()->current()!='http://127.0.0.1:8000/view_my_heritage_visits')
            <a href="{{ url('view_my_heritage_visits') }}" class="btn btn-sm btn-outline-secondary">By Me <span data-feather="user"></span></a>
				@else
			<a href="{{ url('view_heritage_visits') }}" class="btn btn-sm btn-outline-secondary">By All <span data-feather="users"></span></a>
				@endif
            <a  href="{{ url('heritage_visit_excel') }}" class="btn btn-sm btn-outline-secondary">Export <span data-feather="share"></span></a>
          </div>
						...
						<div class="modal-content">
						  ...
						  <div class="modal-body">
							<div class="row">
								...
								<div class="col-md-12">
								<p>Number of Tourists: {{ $a->number }} <br> Heritage Site: {{ $a->heritage_site }}  </p>
