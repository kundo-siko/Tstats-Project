...
@section('content')
  ...
  <div class="row">
    ...
    <div class="col-md-10 order-md-2">
	  ...
	  @if(url()->current()!='http://127.0.0.1:8000/edit_my_departure_details')
	  ...
	  @endif
        @csrf
		 ...
		 <input type="text" class="form-control" id="employee_no" name="employee_no" value="{{ $departure[0]->employee_no }}" hidden>
		 <input type="text" class="form-control" id="id" name="id" value="{{ $departure[0]->id }}" hidden>
		
           <div class="mb-3">
            <label for="nationality">Number of Tourists</label>
            <input type="number" class="form-control" id="number" name="number" placeholder="Number" value="{{ $departure[0]->number }}" required>
    ...
    <div class="col-md-6 order-md-2">
          ...
          <div class="mb-3">
            <label for="continent">Region/Continent</label>
                       <input type="text" class="form-control" id="memo" name="continent" placeholder="Region" value="{{ $departure[0]->continent }}" readonly>
            <div class="invalid-feedback">
    ...
    <div class="col-md-4 order-md-2">
		...
		<div class="mb-3">
            ...
            <input type="text" class="form-control" id="point_region" name="point_region" value="{{ $departure[0]->point_region }}" readonly>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
		...
		<div class="mb-3">
            ...
            <input type="text" class="form-control" id="point_type" name="point_type" value="{{ $departure[0]->point_type }}" readonly>
            <div class="invalid-feedback">
              Valid last name is required.
            </div>
          </div>
